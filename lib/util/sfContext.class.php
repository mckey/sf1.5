...
class sfContext implements ArrayAccess
{
     ...
     *
     * @return sfContext New context instance
     * @throws sfException
     */
    public static function switchTo($name)
    {
        if (!isset(self::$instances[$name])) {
            ...
            $instance = sfContext::createInstance(
              ProjectConfiguration::getApplicationConfiguration(
                $name, $currentConfiguration->getEnvironment(), $currentConfiguration->isDebug()
              )
            );
        ...
        $instance->getConfiguration()->activate();
